                            ...
                            <tbody>
                                @foreach ($histories as $history)
                                    <tr>
                                        ...
                                        <td>{{ $history->medicines->name }}</td>
                                        <td>{{ $history->amount }} {{ $history->medicines->unit }}</td>
                                        <td>{{ $history->time_taken->format('d-m-Y H:i') }}</td>
                                        <td>
                                            ...
                                            <div id="delete-modal-{{ $history->id }}" class="modal-demo">
                                                ...
                                                <div class="custom-modal-text text-center">
                                                    <form action="{{ route('medicines.history.delete', $history->id) }}" method="post">
                                                        @csrf
                                                        @method('DELETE')
